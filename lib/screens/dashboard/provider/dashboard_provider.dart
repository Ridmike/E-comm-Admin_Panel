...
class DashBoardProvider extends ChangeNotifier {
  ...
  addProduct() async {
    try {
      ...
      SnackBarHelper.showErrorSnackBar('An error Accurred: $e');
    }
  }
  ...
  // FilterBrand
  filterbrands(SubCategory subCategory) {
    selectedBrand = null;
  ...
  // FilterVariant
  filterVariants(VariantType variantType) {
    selectedVariants = [];
